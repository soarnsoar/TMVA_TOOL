bmuon_var=[
    ...
    "bmuon_P_jetrest > 2.5 ? 2.5 : bmuon_P_jetrest",
    ...
    "bjet_NeutralHadronEnergyFraction > 0.3 ? 0.3 : bjet_NeutralHadronEnergyFraction",
    "bjet_NeutralMultiplicity > 25 ? 25 : bjet_NeutralMultiplicity",
    "bjet_charge*bmuon_charge < -0.4 ? -0.4 : bjet_charge*bmuon_charge",
    "fabs(bjet_charge) > 0.6 ? 0.6 : fabs(bjet_charge)"
...
belectron_var=[
    ...
    "belectron_ptwrtbjet < 0.5 ? 0.5 : belectron_ptwrtbjet > 3. ? 3. : belectron_ptwrtbjet",
    #"belectron_reliso > 5 ? 5 : belectron_reliso",
    "log10(1.+belectron_reliso) > 1. ? 1. : log10(1.+belectron_reliso)",
    
    "bjet_ChargedEmEnergyFraction > 0.2 ? 0.2 : bjet_ChargedEmEnergyFraction",
    "bjet_ChargedHadronEnergyFraction < 0.3 ? 0.3 : bjet_ChargedHadronEnergyFraction > 0.8 ? 0.8 : bjet_ChargedHadronEnergyFraction",
...
bjet_var=[
    ...
    "bjet_NeutralMultiplicity > 30 ? 30 : bjet_NeutralMultiplicity < 5 ? 5 : bjet_NeutralMultiplicity",
    "fabs(bjet_charge)"   
]
