...
def Export(WORKDIR,command,jobname,submit,ncpu,memory=False,nretry=3):
    ...
    lines.append("export PATH="+os.getenv("PATH"))
    lines.append("export JH_TMVA_TOOL_MAINDIR="+os.getenv("JH_TMVA_TOOL_MAINDIR"))
    lines.append("export PYTHONPATH="+os.getenv("PYTHONPATH"))
