...
#---3rd
#{'Trf': 'G', 'BoostType': 'Grad', 'Shrinkage__AdaBoostBeta': '0.01', 'NTrees': '500', 'MaxDepth': '4', 'MinNodeSize': '1.5', 'UseBaggedBoost': 'True', 'BaggedSampleFraction': '0.3', 'SeparationType': 'GiniIndex', 'nCuts': '10', 'IgnoreNegWeightsInTraining': 'True', 'auc': 0.759888772148367, 'sigeff_B0p3': [0.68, 0.714], 'sigeff_B0p1': [0.395, 0.419], 'sigeff_B0p01': [0.095, 0.102]}
list_Shrinkage=['0.001','0.01','0.1']
list_NTrees=['10','100','300','500','600','700','800', '1200']
list_MaxDepth=['2','4','6']
list_BaggedSampleFraction=['0.3']+['0.1','0.2','0.4','0.5']
list_MinNodeSize=['0.5','1.5','5']
list_nCuts=['2','5','7','10']
...
list_MaxDepth=['2','4','8']
list_BaggedSampleFraction=['0.1','0.3','.7']
