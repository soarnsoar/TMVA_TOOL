...
##--3rd
#{'Trf': 'N', 'BoostType': 'Grad', 'Shrinkage__AdaBoostBeta': '0.01', 'NTrees': '800', 'MaxDepth': '4', 'MinNodeSize': '10', 'UseBaggedBoost': 'True', 'BaggedSampleFraction': '0.4', 'SeparationType': 'GiniIndex', 'nCuts': '30', 'IgnoreNegWeightsInTraining': 'True', 'auc': 0.710613231305252, 'sigeff_B0p3': [0.606, 0.611], 'sigeff_B0p1': [0.322, 0.353], 'sigeff_B0p01': [0.069, 0.076]}


list_Shrinkage=['0.001','0.01','0.1']
list_NTrees=['600','800','1200']
list_MaxDepth=['2','4','6']
list_BaggedSampleFraction=['0.01','0.1','0.2','0.4','0.5']
list_MinNodeSize=['10','15','20','30']
list_nCuts=['30','40','50','70']


#{'Trf': 'N', 'BoostType': 'Grad', 'Shrinkage__AdaBoostBeta': '0.01', 'NTrees': '800', 'MaxDepth': '6', 'MinNodeSize': '10', 'UseBaggedBoost': 'True', 'BaggedSampleFraction': '0.4', 'SeparationType': 'GiniIndex', 'nCuts': '30', 'IgnoreNegWeightsInTraining': 'True', 'auc': 0.7107237743211294, 'sigeff_B0p3': [0.606, 0.615], 'sigeff_B0p1': [0.322, 0.354], 'sigeff_B0p01': [0.07, 0.076]}

list_Shrinkage=['0.001','0.01','0.1']
list_NTrees=['600','800','1200']
list_MaxDepth=['2','6','10']
list_MinNodeSize=['1','10','30']
list_BaggedSampleFraction=['0.1','0.4','0.8']
list_nCuts=['10','30','70']
