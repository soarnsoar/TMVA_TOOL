...
import sys
def GetVariableConfig(version,year):
        version=str(version)
        sys.path.append(maindir+"/config/ForBDT/v"+version+"/"+year)
...
if __name__== '__main__':
        ...
        bmuon_var,belectron_var,bjet_var=GetVariableConfig(version,year)
