...
(mkdir -p electron${year} && cd electron${year} &&run_N_1.py --nlayer 5 --name electron_test --nnode 64 --nepoch 300 --batchsize 500 --dropout 0.2 --version 2405.4 --channel electron --year $year --analyzer EEMu_MuMuE_Method --transform G --auc_cut 0.72 && cd -) &> electron_$year.log&
